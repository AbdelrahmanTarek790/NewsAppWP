...
router.post(
    ...
    [
        ...
        body("content").notEmpty().withMessage("A post must have content"),
        body("excerpt").optional().isLength({ max: 200 }).withMessage("An excerpt cannot be more than 200 characters"),
        body("status")
            .optional()
...
router.patch(
    "/:id",
    [
        body("title").optional().isLength({ max: 100 }).withMessage("A post title cannot be more than 100 characters"),
        body("excerpt").optional().isLength({ max: 200 }).withMessage("An excerpt cannot be more than 200 characters"),
        body("status")
            .optional()
            .isIn(["draft", "published", "scheduled", "archived"])
