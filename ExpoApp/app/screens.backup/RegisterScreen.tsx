        ...
        <Center >
            <Box >
                <VStack >
                    ...
                    <VStack space="md">
                        ...
                        <Box>
                            <Input variant="outline" size="lg" isInvalid={!!errors.password}>
                                <InputField placeholder="Password" value={password} onChangeText={setPassword} secureTextEntry={!showPassword} />
                        ...
                        <Box>
                            <Input variant="outline" size="lg" isInvalid={!!errors.confirmPassword}>
                                <InputField
                    ...
                    <Button size="lg" variant="solid" action="primary"  onPress={handleRegister} isDisabled={isLoading}>
                        {isLoading ? (
                            <HStack space="sm" >
                                <Spinner size="small" />
